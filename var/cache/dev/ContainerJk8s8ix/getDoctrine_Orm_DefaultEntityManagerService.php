...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'/src/alomedBundle/Entity'), 1 => ($this->targetDirs[3].'/src/HotelBundle/Entity')]);

$b->addDriver($c, 'alomedBundle\\Entity');
$b->addDriver($c, 'HotelBundle\\Entity');

$a->setEntityNamespaces(['alomedBundle' => 'alomedBundle\\Entity', 'HotelBundle' => 'HotelBundle\\Entity']);
