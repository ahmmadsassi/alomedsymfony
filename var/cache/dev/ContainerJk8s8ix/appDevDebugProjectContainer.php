...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('nmwAtEmM98', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xSRrJmm5QW', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('w3ojp+4VRp', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+qxXYWSnmK', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/alomedBundle/Resources/views'), 'alomed');
        $instance->addPath(($this->targetDirs[3].'/src/alomedBundle/Resources/views'), '!alomed');
        $instance->addPath(($this->targetDirs[3].'/src/HotelBundle/Resources/views'), 'Hotel');
        $instance->addPath(($this->targetDirs[3].'/src/HotelBundle/Resources/views'), '!Hotel');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'alomedBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/alomedBundle'),
                    'namespace' => 'alomedBundle',
                ],
                'HotelBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/HotelBundle'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'alomedBundle' => 'alomedBundle\\alomedBundle',
                'HotelBundle' => 'HotelBundle\\HotelBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'Alomed',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'sassiahmed147852@gmail.com',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'sassiahmed147852@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'mypass',
