...
$b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'/src/alomedBundle/Entity')]), 'alomedBundle\\Entity');

$a->setEntityNamespaces(['alomedBundle' => 'alomedBundle\\Entity']);
