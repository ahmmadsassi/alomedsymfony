 ...
 */
class livreur extends \alomedBundle\Entity\livreur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'alomedBundle\\Entity\\livreur' . "\0" . 'id', '' . "\0" . 'alomedBundle\\Entity\\livreur' . "\0" . 'nom', '' . "\0" . 'alomedBundle\\Entity\\livreur' . "\0" . 'prenom', '' . "\0" . 'alomedBundle\\Entity\\livreur' . "\0" . 'DateDeNaissance', '' . "\0" . 'alomedBundle\\Entity\\livreur' . "\0" . 'livraisons', '' . "\0" . 'alomedBundle\\Entity\\livreur' . "\0" . 'password', '' . "\0" . 'alomedBundle\\Entity\\livreur' . "\0" . 'email', '' . "\0" . 'alomedBundle\\Entity\\livreur' . "\0" . 'telephone', '' . "\0" . 'alomedBundle\\Entity\\livreur' . "\0" . 'addresse'];
        }
