 ...
 */
class Patient extends \alomedBundle\Entity\Patient implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'alomedBundle\\Entity\\Patient' . "\0" . 'id', '' . "\0" . 'alomedBundle\\Entity\\Patient' . "\0" . 'nom', '' . "\0" . 'alomedBundle\\Entity\\Patient' . "\0" . 'prenom', '' . "\0" . 'alomedBundle\\Entity\\Patient' . "\0" . 'DateDeNaissance', '' . "\0" . 'alomedBundle\\Entity\\Patient' . "\0" . 'ordonnancesp', '' . "\0" . 'alomedBundle\\Entity\\Patient' . "\0" . 'livraisons', '' . "\0" . 'alomedBundle\\Entity\\Patient' . "\0" . 'password', '' . "\0" . 'alomedBundle\\Entity\\Patient' . "\0" . 'email', '' . "\0" . 'alomedBundle\\Entity\\Patient' . "\0" . 'telephone', '' . "\0" . 'alomedBundle\\Entity\\Patient' . "\0" . 'addresse'];
        }
    ...
    public function getOrdonnancesp()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOrdonnancesp', []);

        return parent::getOrdonnancesp();
    }
    ...
    public function setOrdonnancesp($ordonnancesp)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOrdonnancesp', [$ordonnancesp]);

        return parent::setOrdonnancesp($ordonnancesp);
    }
